  ...
  return (
    <FullWindowOverlay>
      <DialogPrimitive.Overlay
        className={cn(
          'absolute bottom-0 left-0 right-0 top-0 flex items-center justify-center bg-black/90 p-2',
          Platform.select({
    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          className={cn(
            'z-50 mx-auto flex w-full flex-col gap-4 rounded-lg p-6 shadow-lg shadow-black/5',
            Platform.select({
