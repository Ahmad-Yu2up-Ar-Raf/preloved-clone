...
export function ShareButton({
  ...
  const primaryForegroundColor = THEME[currentTheme].primaryForeground;
  const secondaryForegroundColor = THEME[currentTheme].secondaryForeground;

  const destructiveForegroundColor = THEME[currentTheme].primary;
  ...
  return (
    <Button onPress={handleShare} variant={variant} size={size} disabled={isButtonDisabled}>
      {buttonContent()}
    </Button>
  );
}
