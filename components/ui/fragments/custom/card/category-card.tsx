...
export function CategoryCard({
  ...
  index,
  ...props
}: CategoryCardProps & ViewProps & React.RefAttributes<View>) {
  ...
  return (
    <Card
      ...
      style={{
        width: CARD_WIDTH,
        height: CARD_WIDTH * 0.4, // Adjust height as needed
      }}
      {...props}>
      <Pressable
        onPress={() => {
        ...
        <CardContent className="w-full overflow-hidden p-0">
          <ImageBackground
            ...
            />
            <View className="relative z-30 h-full w-full items-start justify-end overflow-hidden rounded-xl p-2.5">
